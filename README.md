...
depth charts, team-needs context, OTC contract/free-agent refresh, transactions, mocks, and Astro data rebuilds:
...
4. `scripts/pull_otc_contracts.py`
...
python3 scripts/refresh_update_workflow.py --skip-otc-fetch
